...
class SecondWeekTests(TestCase):
    ...
    def test_incex_contains_message(self):
        response = self.client.get(reverse('index'))
        self.assertIn(
            b'The library has the following record counts:', response.content)
    ...
    def test_challenge_part5_two(self):
        ...
        self.assertIn(b"Books containing the letter 'a' in the title:",
                      response.content)  # Fix this in your code
